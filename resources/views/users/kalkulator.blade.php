...
@section('content')
    ...
    <section class="w-full px-4 lg:px-10 my-24 lg:my-36">
        ...
        <div class="flex flex-col w-full items-center">
            <form action="{{ route('kalkulator.store') }}" method="POST" class="w-full lg:w-3/4 mx-auto" id="kalkulatorForm">
                @csrf
                <div class="flex flex-col gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-900 lg:text-lg">Kecamatan</label>
